...
## Finished Game Runtime Package
Run `python3 tools/generate_finished_game.py` after full game generation to create `12_finished_game/`, the final runtime campaign, online, gameplay systems, UI, Android, and Play Store release handoff derived exclusively from repository JSON and materialized metadata.
